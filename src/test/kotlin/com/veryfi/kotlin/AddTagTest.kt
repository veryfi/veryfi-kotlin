...
import com.veryfi.kotlin.documents.addTag
import com.veryfi.kotlin.documents.addTagAsync
...
class AddTagTest: ClientTest() {
    ...
    fun addTagTest() {
        if (mockResponses) {
            ...
            val fileStream = ClassLoader.getSystemResourceAsStream("addTag.json")!!
        ...
        val jsonResponse = client.addTag("31727276", "TEST_TAG")
        val document = JSONObject(jsonResponse)
        Assertions.assertEquals("test_tag", document.getString("name").lowercase())
    }
    ...
    fun addTagAsyncTest() {
        ...
        val jsonResponseFuture = client.addTagAsync("31727276", "TEST_TAG")

...
@SpringBootTest
class GetBusinessCardTest: ClientTest() {

    @Test
    @Throws(IOException::class, InterruptedException::class)
    fun getBusinessCardTest() {
        val documentId = "4662609" // Change to your document Id
        if (mockResponses) {
            val httpClient = mock(HttpClient::class.java)
            client.setHttpClient(httpClient)
            val fileStream = ClassLoader.getSystemResourceAsStream("getBusinessCard.json")!!
        ...
        val jsonResponse = client.getBusinessCard(documentId)
    ...
    fun getBusinessCardAsyncTest() {
        ...
        val jsonResponseFuture = client.getBusinessCardAsync(documentId)

...
import com.veryfi.kotlin.split.getSplitDocument
import com.veryfi.kotlin.split.getSplitDocumentAsync
...
@SpringBootTest
class GetSplitDocumentTest: ClientTest() {

    @Test
    @Throws(IOException::class, InterruptedException::class)
    fun getSplitDocumentTest() {
        val documentId = "351609" // Change to your document Id
        if (mockResponses) {
            val httpClient = mock(HttpClient::class.java)
            client.setHttpClient(httpClient)
            val fileStream = ClassLoader.getSystemResourceAsStream("getSplit.json")!!
        ...
        val jsonResponse = client.getSplitDocument(documentId)
    ...
    @Test
    @Throws(IOException::class, InterruptedException::class)
    fun getSplitDocumentTestWithException() {
        val documentId = "351609" // Change to your document Id
        val httpClient = mock(HttpClient::class.java)
        client.setHttpClient(httpClient)
        `when`(
    ...
    fun getSplitDocumentAsyncTest() {
        ...
        val jsonResponseFuture = client.getSplitDocumentAsync(documentId)

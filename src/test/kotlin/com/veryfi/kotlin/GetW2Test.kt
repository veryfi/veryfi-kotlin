...
@SpringBootTest
class GetW2Test: ClientTest() {

    @Test
    @Throws(IOException::class, InterruptedException::class)
    fun getW2Test() {
        val documentId = "4609400" // Change to your document Id
        if (mockResponses) {
            val httpClient = mock(HttpClient::class.java)
            client.setHttpClient(httpClient)
            val fileStream = ClassLoader.getSystemResourceAsStream("getW2.json")!!
        ...
        val jsonResponse = client.getW2(documentId)
    ...
    fun getW2AsyncTest() {
        ...
        val jsonResponseFuture = client.getW2Async(documentId)

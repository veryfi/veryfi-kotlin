...
class GetW2sTest: ClientTest() {
    ...
    fun getW2sTest() {
        if (mockResponses) {
            ...
            val fileStream = ClassLoader.getSystemResourceAsStream("getW2s.json")!!
    ...
    fun getW2sAsyncTest() {
        ...
        val jsonResponseFuture = client.getW2sAsync()

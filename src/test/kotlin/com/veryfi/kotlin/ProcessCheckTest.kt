...
import com.veryfi.kotlin.checks.processCheck
import com.veryfi.kotlin.checks.processCheckAsync
...
@SpringBootTest
class ProcessCheckTest: ClientTest() {

    @Test
    @Throws(IOException::class, InterruptedException::class)
    fun processCheckTest() {
        if (mockResponses) {
        ...
        val path = ClassLoader.getSystemResource("check.pdf").path
        val jsonResponse = client.processCheck(path, null)
    ...
    fun processCheckAsyncTest() {
        ...
        val path = ClassLoader.getSystemResource("check.pdf").path
        val jsonResponseFuture = client.processCheckAsync(path, null)

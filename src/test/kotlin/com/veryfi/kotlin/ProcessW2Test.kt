...
@SpringBootTest
class ProcessW2Test: ClientTest() {
    ...
    fun processW2Test() {
        ...
        val path = ClassLoader.getSystemResource("w2.png").path
        val jsonResponse = client.processW2(path, null)
    ...
    fun processW2AsyncTest() {
        ...
        val path = ClassLoader.getSystemResource("w2.png").path
        val jsonResponseFuture = client.processW2Async(path, null)
